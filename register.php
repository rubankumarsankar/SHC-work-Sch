...
<header >
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active">
                 ...
                 <li> <a href="feedback.php" class="nav-link text-left">Feedback</a></li>
 ...
 <center><h2 style="color:#EE1616;"><b>Register</b></h2>
		<div style="margin-top:-10px;" class="hidden-xs"><h4 style="color:#000066; margin-top:-10px;"><b>Student they can Register the Scholarship .</b></h4>

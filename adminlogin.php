...
<header >
	  ...
	  <center><h2 style="color:#EE1616;"><b>ADMIN lOGIN</b></h2>
		<div style="margin-top:-10px;" class="hidden-xs"><h4 style="color:#000066; margin-top:-10px;"><b>SHC Work Scholarships Administrator Only.</b></h4>
				<h4 style="color:#000066; margin-top:-10px;">            
		</div>
		</center>
	   <div class="container">
<div class="row">  <form action="adminLogProcess.php" method="post">

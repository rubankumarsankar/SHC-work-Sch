            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active">
                  ...
                  <li><a href="#"  style="margin-right:20px">Student details</a><br></li>
...
<fieldset>
	  <center><h2 style="color:#EE1616;"><b>Student Details</b></h2>
...
if(!$conn)
{
    die("Database not connected: " . mysqli_error());
      ...
      <div class="table-container">
			<table border="1"> <div style="margin-top :0px; margin-bottom : 30px; margin-left:100px;margin-right;100px"> 
			<tr>  

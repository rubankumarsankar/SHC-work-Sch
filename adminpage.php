...
<header >
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active">
                 ...
                 <li> <a href="studentdetails.php" class="nav-link text-left"> Student Details</a></li>
				 <li> <a href="attendancedetails.php" class="nav-link text-left"> Attendance Details</a></li>
         <li> <a href="feedbackdetails.php" class="nav-link text-left"> Feedback Details</a></li>
				 <li><a href="logout.php" class="nav-link text-left">Log out</a></li>
              </ul>
			  </li>
            </nav>
          </div>        
	  ...
	  <center><h2 style="color:#EE1616;"><b>Administrator</b></h2>
		<div style="margin-top:-10px;" class="hidden-xs"><h4 style="color:#000066; margin-top:-10px;"><b>The head of our whole system.</b></h4>

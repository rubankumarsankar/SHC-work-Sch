...
<header >
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active">
                 ...
                 <li> <a href="#" class="nav-link text-left">Student Login</a></li>
              </ul>
			  </li>
            </nav>
          </div>        
	  ...
	  <center><h2 style="color:#EE1616;"><b>STUDENT lOGIN</b></h2>
		<div style="margin-top:-10px;" class="hidden-xs"><h4 style="color:#000066; margin-top:-10px;"><b>Student can only login this page.</b></h4>
				<h4 style="color:#000066; margin-top:-10px;">            
		</div>
		</center>
	   <div class="container">
<div class="row">  <form action="studentLogProcess.php" method="post">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="password" id="pword" name="pwd" class="form-control form-control-lg">
                        </div>
                        <div class="row">
                        <div class="col-md-5">
